...
exports.assertion = function(selector, expected, msg) {
		...
		var MSG_ELEMENT_NOT_FOUND = 'Testing if the count for the element <%s> is less than %s. ';

		this.message = msg || util.format('Testing if the count for the element <%s> is less than %s.', selector, expected);
