...
exports.assertion = function(selector, expected, msg) {
		...
		var MSG_ELEMENT_NOT_FOUND = 'Testing if the count for the element <%s> is greater than %s. ';

		this.message = msg || util.format('Testing if the count for the element <%s> is greater than %s.', selector, expected);
